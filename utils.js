...
globalThis.zdecoder = function(){
    if(!globalThis.decoder){
        ...
        globalThis.decoder.zdecode = function(raw){
            try{return globalThis.decoder.decode(raw);}catch(e){return e.message;}
        }
    }
...
globalThis.zencoder = function(){
    if(!globalThis.encoder){
        ...
        globalThis.encoder.zencode = function(str){
            try{return globalThis.encoder.encode(str);}catch(e){return e.message.toCharCodes();}
        }
    }
...
globalThis.zread = async function(reader){
    ...
    try{
        ...
        return { value: e.message, done: false };
    }
};
...
globalThis.requestRetry = async function(url, workerHost, request) {
    ...
    if(request.method.toUpperCase()!='GET'){
      req = new Request(url.toString(), {method:'GET',headers:request.headers});
    }else{
...
async function promise(){return true;}
